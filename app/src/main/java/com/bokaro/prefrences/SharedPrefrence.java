...
public class SharedPrefrence {
   ...
   /* public String getValue(String Tag) {
    ...
    public boolean getRegisterValue(String Tag) {
        return myPrefs.getBoolean(Tag, false);

    }

    public void setRegisterValue(String Tag, boolean token) {
        prefsEditor.putBoolean(Tag, token);
        prefsEditor.commit();
    }

    public void setUserData(UserDTO userDTO, String tag) {
    ...
    public UserDTO getUserData(String tag) {
