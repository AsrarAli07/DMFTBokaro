...
public class DialogStatusAdapter extends RecyclerView.Adapter<DialogStatusAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> arrayList;
    NewProjectFragment newProjectFragment;
    AdapterFinancialYearViewBinding binding;

    public DialogStatusAdapter(Context mContext, ArrayList<String> arrayList, NewProjectFragment newProjectFragment) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newProjectFragment.setStatus(arrayList.get(position));
