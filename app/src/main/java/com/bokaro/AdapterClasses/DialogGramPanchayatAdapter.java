...
public class DialogGramPanchayatAdapter extends RecyclerView.Adapter<DialogGramPanchayatAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> arrayList;
    NewProjectFragment newProjectFragment;
    AdapterFinancialYearViewBinding binding;

    public DialogGramPanchayatAdapter(Context mContext, ArrayList<String> arrayList, NewProjectFragment newProjectFragment) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newProjectFragment.setGramPanchayat(arrayList.get(position));
