...
public class DialogAgencyAdapter extends RecyclerView.Adapter<DialogAgencyAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> arrayList;
    NewProjectFragment newProjectFragment;
    AdapterFinancialYearViewBinding binding;

    public DialogAgencyAdapter(Context mContext, ArrayList<String> arrayList, NewProjectFragment newProjectFragment) {
    ...
    @NotNull
    @Override
    public DialogAgencyAdapter.MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newProjectFragment.setAgency(arrayList.get(position));
