...
public class DialogSectorAdapter extends RecyclerView.Adapter<DialogSectorAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> arrayList;
    NewProjectFragment newProjectFragment;
    AdapterFinancialYearViewBinding binding;

    public DialogSectorAdapter(Context mContext, ArrayList<String> arrayList, NewProjectFragment newProjectFragment) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                newProjectFragment.setSector(arrayList.get(position));
