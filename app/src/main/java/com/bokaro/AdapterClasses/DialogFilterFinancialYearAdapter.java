...
public class DialogFilterFinancialYearAdapter extends RecyclerView.Adapter<DialogFilterFinancialYearAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> arrayList;
    ProjectListFragment projectListFragment;
    AdapterFinancialYearViewBinding binding;

    public DialogFilterFinancialYearAdapter(Context mContext, ArrayList<String> arrayList, ProjectListFragment projectListFragment) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                projectListFragment.setFinancialYear(arrayList.get(position));
